...
function build_table(policies) {
  ...
  jQuery.each( policies, function( i, val ) {
    if(val.POLICY_Type == null) {val.POLICY_Type = ""};
    if(val.POLICY_url == null) {val.POLICY_url = ""};
    if(val.POLICY_Name == null) {val.POLICY_Name = ""};
    if(val.POLICY_YearPublish == null) {val.POLICY_YearPublish = ""};
    if(val.POLICY_Description == null) {val.POLICY_Description = ""};
  ...
  if(val.POLICY_Name != "") {$( "#state-policies #policies-table #no-results" ).remove();}
  });
...
function set_map_active(sector) {
  ...
  if(sector == "hover_energy") {$("#map-svg").addClass('selected_energy');  $( "#climate-action-map-content" ).addClass( "selected_energy" );} 
  if(sector == "hover_building") {$("#map-svg").addClass('selected_building');  $( "#climate-action-map-content" ).addClass( "selected_building" );} 
  if(sector == "hover_cross") {$("#map-svg").addClass('selected_cross');  $( "#climate-action-map-content" ).addClass( "selected_cross" );} 
  if(sector == "hover_industry") {$("#map-svg").addClass('selected_industry');  $( "#climate-action-map-content" ).addClass( "selected_industry" );} 
  if(sector == "hover_transportation") {$("#map-svg").addClass('selected_transportation');  $( "#climate-action-map-content" ).addClass( "selected_transportation" );} 
  if(sector == "hover_natural") {$("#map-svg").addClass('selected_natural');  $( "#climate-action-map-content" ).addClass( "selected_natural" );} 
  if(sector == "hover_2030") {$("#map-svg").addClass('selected_2030');  $( "#climate-action-map-content" ).addClass( "selected_2030" );} 
  if(sector == "hover_post") {$("#map-svg").addClass('selected_post');  $( "#climate-action-map-content" ).addClass( "selected_post" );} 
}
...
function about_tab(state) {
    ...
    $( "#about-tab" ).replaceWith('<div id="about-tab"><h3>This is a sentence about: ' + about_data + '</h3>' + date_1 + '' + date_2 + '</div>');
...
$( "#map-svg .default-state" ).on( "click", function( event ) {
  ...
  } else {   $( "#about-tab" ).css("display","none"); 
}
